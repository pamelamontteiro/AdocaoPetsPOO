...
class TelaCachorro:
    ...
    def pega_dados_cachorro(self, racas):
        ...
        layout = [
            ...
            [sg.InputCombo(("P", "M", "G"), readonly=True, key="tamanho", default_value="P", background_color="white", font=self.__font)],
            [sg.Push(), sg.Button("Retornar", button_color=("black", "white"), font=self.__font), sg.Push(), sg.Button("Confirmar", button_color=("black", "white"), font=self.__font)]
        ]
    ...
    def seleciona_cachorro(self):
        ...
        self.__window = sg.Window("Selecionar cachorro pelo número do chip", layout, finalize=True)
        button, values = self.open()
    ...
    def mostra_cachorro(self, cachorro, racas):
        ...
        layout = [
            ...
            [sg.Text("Nome do cachorro", font=self.__font)],
            [sg.Input(key="nome", default_text=cachorro.nome, font=self.__font, background_color="white")],
            [sg.Text("Raça", font=self.__font)],
            [sg.InputCombo(racas, readonly=True, key="raca", default_value=cachorro.raca, background_color="white", font=self.__font)],
            [sg.Text("Tamanho", font=self.__font)],
            [sg.InputCombo(("P", "M", "G"), readonly=True, key="tamanho", default_value=cachorro.tamanho, background_color="white", font=self.__font)],
            [sg.Push(), sg.Button("Retornar", button_color=("black", "white"), font=self.__font), sg.Push(), sg.Button("Confirmar", button_color=("black", "white"), font=self.__font)]
        ]
    ...
    def mostrar_cachorros(self, cachorros):
        ...
        layout = [
            ...
            [sg.Table(headings=["Numero do Chip", "Nome", "Raça", "Tamanho", "Vacinação"], values=cachorros, size=(50, 6), background_color="gray", font=self.__font)],
