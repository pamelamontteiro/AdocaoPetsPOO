...
class TelaVacinacao:
    ...
    def abre_tela(self):
        ...
        layout = [
            [
                sg.Radio(
                    "Incluir histórico de vacinação",
                    "Radio1",
                    key="1",
                    font=self.__font,
                )
            ...
            [
                sg.Radio(
                    "Listar históricos de vacinação",
                    "Radio1",
                    key="2",
                    font=self.__font,
                )
    ...
    def pega_dados_historico(self):
        ...
        layout = [
            ...
            [
                sg.Input(
                    key="numero_chip_animal", font=self.__font, background_color="white"
                )
            ],
            [
                sg.Push(),
        ...
        self.__window = sg.Window(
            "Incluir histórico de vacinação", layout, finalize=True
        )
        self.__window.set_min_size((300, 200))
