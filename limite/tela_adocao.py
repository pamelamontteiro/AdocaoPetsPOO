...
class TelaAdocao:
    ...
    def pega_dados_adocao(self):
        ...
        layout = [
            ...
            [sg.Text(key="termo_responsabilidade", font=self.__font)],
            [sg.RadioButton("Sim", "termo_responsabilidade", key="sim", font=self.__font), sg.RadioButton("Não", "termo_responsabilidade", key="nao", font=self.__font)],
            [sg.Push(), sg.Button("Retornar", button_color=("black", "white"), font=self.__font), sg.Push(), sg.Button("Confirmar", button_color=("black", "white"), font=self.__font)]
        ]
    ...
    def exibir_adocoes(self, adocoes):
        ...
        layout = [
            ...
            [sg.Table(headings=["ID", "Data de adoção", "CPF do adotante", "Número do chip do animal", "Termo de responsabilidade"], values=adocoes, size=(50, 6), background_color="gray", font=self.__font)],
